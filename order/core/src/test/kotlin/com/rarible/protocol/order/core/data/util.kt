...
fun createOrder() =
    Order(
        maker = AddressParser.parse("0xca8ea83f10b7098e989293c0b638048d0eed38ae"), //AddressFactory.create(),
        taker = null,
        make = createMake("1"),
        take = createEth(),
        ...
        cancelled = false,
        salt = EthUInt256(BigInteger("113074335922849805638551220245119743573184717714175756857947602553447531531034")),
        start = null,
        end = null,
        data = OrderRaribleV2DataV2(emptyList(), emptyList(), true),
        signature = Binary.apply("0xff91aa10fe0f202ab15b4a3a2c4a348f2b68f787085c88346feeaaa8a1e416ce2787ece0e536cfd09387f6263bb28f1e659c5af85265b7e8407ee668c4c476e21b"),
        createdAt = nowMillis(),
...
fun createEth(): Asset {
    return Asset(
        type = EthAssetType,
        value = EthUInt256(BigInteger("1000000000000000"))
    )
}
fun createMake(value:String): Asset {
    return Asset(
        type = createAssetType("0x6ede7f3c26975aad32a475e1021d8f6f39c89d82"),
...
fun createAssetType(address:String): AssetType {
    ...
    tokenId = EthUInt256(BigInteger("91619248890641535729145178084020995269514601992617283123766342733240704434233")))
}
